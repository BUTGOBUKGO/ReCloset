	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<c:forEach items="${goods}" var="goods">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ${ goods.categoryCode == 1 ? 'Item' : goods.categoryCode == 2 ? 'acc' : goods.categoryCode == 3 ? 'woman' : goods.categoryCode == 4 ? 'men' : 'etc' }">
					<!-- Block2 -->
					<div class="block2">
