...
public class Member implements Serializable{
   ...
   public Member(int userNo, int userCodeNo, String userId, String userPwd, String userName, Date birthday,
         String zip, String address1, String address2, String phone, String email, String gender, String marketname,
         String bank, String atholder, String anumber, String status) {
      super();
      this.userNo = userNo;
   ...
   public String toString() {
      return "Member [userNo=" + userNo + ", userCodeNo=" + userCodeNo + ", userId=" + userId + ", userPwd=" + userPwd
            + ", userName=" + userName + ", birthday=" + birthday + ", zip=" + zip + ", address1=" + address1
